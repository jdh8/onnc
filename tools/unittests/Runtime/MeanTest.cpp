...
SKYPAT_F(Operator_Mean, test_mean_example) {
  ...
  ONNC_RUNTIME_mean_float(nullptr, inputs, 3, input_ndims, input_shapes, output_0, output_0_ndim, output_0_dims);
...
SKYPAT_F(Operator_Mean, test_mean_one_input) {
  ...
  ONNC_RUNTIME_mean_float(nullptr, inputs, 1, input_ndims, input_shapes, output_0, output_0_ndim, output_0_dims);
  dragonite::verify(output_0, answer_0, 3);
}
...
SKYPAT_F(Operator_Mean, test_mean_two_inputs) {
  ...
  ONNC_RUNTIME_mean_float(nullptr, inputs, 2, input_ndims, input_shapes, output_0, output_0_ndim, output_0_dims);
  dragonite::verify(output_0, answer_0, 3);
}
