...
SKYPAT_F(Operator_Max, test_max_example) {
  ...
  ONNC_RUNTIME_max_float(nullptr, inputs, 3, input_ndims, input_shapes, output_0, output_0_ndim, output_0_dims);
  dragonite::verify(output_0, answer_0, 3);
}

SKYPAT_F(Operator_Max, test_max_one_input) {
  const float input_0[] = {3.0, 2.0, 1.0};
  const int32_t input_0_ndim = 1;
  const int32_t input_0_dims[] = {3};
  float output_0[3];
  ...
  ONNC_RUNTIME_max_float(nullptr, inputs, 1, input_ndims, input_shapes, output_0, output_0_ndim, output_0_dims);
  dragonite::verify(output_0, answer_0, 3);
}

SKYPAT_F(Operator_Max, test_max_two_inputs) {
  const float input_0[] = {3.0, 2.0, 1.0};
  const int32_t input_0_ndim = 1;
  const int32_t input_0_dims[] = {3};
  const float input_1[] = {1.0, 4.0, 4.0};
  ...
  const int32_t output_0_ndim = 1;
  const int32_t output_0_dims[] = {3};
  const float answer_0[] = {3.0, 4.0, 4.0};
  ...
  ONNC_RUNTIME_max_float(nullptr, inputs, 2, input_ndims, input_shapes, output_0, output_0_ndim, output_0_dims);
  dragonite::verify(output_0, answer_0, 3);
}
